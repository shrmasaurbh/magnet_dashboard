...
import {faComments, faSearch, faBars, faBell} from "@fortawesome/free-solid-svg-icons";
	...
	render(){
		...
		return(
            ...
            <Aux>
    			...
    			<nav className={"main-header navbar navbar-expand navbar-white navbar-light"+" "+(this.props.expand ? 'main-header-collapsed' : '')}>
